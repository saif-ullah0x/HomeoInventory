...
import LearningAssistantFixed from "@/components/learning-assistant-fixed";
...
export default function Header() {
  ...
  return (
    <header className="bg-background border-b shadow-sm glass-effect">
      ...
      <LearningAssistantFixed isOpen={showLearningSystem} onClose={() => setShowLearningSystem(false)} />
    </header>
  );
}
